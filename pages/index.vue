    ...
    .jumbotron.text-white.rounded-0
      .container
        .row.align-items-center.flex-row-reverse
          ...
          .col-md-7
            h1.display-4.font-weight-bold Bootstrap-XD
            h2.lead Bootstrap Design Template â€” Assets Library â€” for Adobe XD
            ...
            a.btn.btn-lg.btn-outline-light.ml-2(href="//github.com/6qd/bootstrap-xd/releases" target="_blank") History
</template>
